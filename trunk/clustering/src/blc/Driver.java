...
enum DriverAction {NOTHING, BUILD_DICTIONARY, BUILD_DOCUMENTS, SET_OPTIONS,
                   SHOW_OPTIONS, NORMALIZE_VECTORS, CLUSTER, CLUSTER_IN_MEMORY}
...
public class Driver {
  ...
  public void createClusterOptions (String outputPath) {
    ...
    try {
      BirchClusterOptions.serializeBirchClusterOptions(this.clusterOptions,
                                                       outputPath);
    } catch (Exception e) {
  ...
  public static void main (String[] args) {
    ...
    switch (driver.driverAction) {
      ...
      case BUILD_DICTIONARY:
        ...
        /* driver.bkmInputPath == null || */
        driver.bkmOutputPath == null)) {
          System.out.println(
   ...
   * @return
   */
  public int parseAndSerializeDocuments (String in,
                                         String out,
                                         StopList stopList,
                                         IStemmer stemmer) {
